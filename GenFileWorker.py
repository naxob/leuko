...
if __name__ == '__main__':
    #taketime(runit, 1)
    test = ['GTSF1', 'cg06809675', 'chr12', "5'UTR", '', '0.90', '0.93', '0.77', '0.89', '0.81', '0.62', '0.84', '0.92', '0.87', '0.94', '0.90', '0.75', '0.59', '0.92', '0.59', '0.83', '0.79', '0.86', '0.82', '0.83', '0.49', '0.82', '0.84', '0.5963839', '0.9348064', '0.8138945', '0.8484759', '0.9797667', '0.8272308', '0.8769273', '0.4233869', '0.8663554', '0.8606881', '0.5317408', '0.5562184', '0.5856701', '0.5312411', '0.3628491', '0.8045131', '0.6372017', '0.63496', '0.8354757', '0.8158629', '0.8933675', '0.919351', '0.3849021', '0.6223825', '0.8541269', '0.7423281', '0.5644814', '0.4243498', '0.6001283', '0.7338768', '0.5901819', '0.8073136', '0.8424758', '0.9302013', '0.6929808', '0.9524847', '0.8199773', '0.8564305', '0.5440429', '0.9182729', '0.8956858', '0.8910309', '0.4263824', '0.6133776', '0.8234742', '0.8828341', '0.2043987', '', '', '3456805', 'chr12', '-', '54849626', '54867391', 'main', '5.424', '6.16', '8.6', '6.312', '10.511', '7.992', '11.193', '10.615', '7.31', '8.428', '7.292', '8.786', '11.603', '10.797', '7.907', '4.95', '4.831', '10.431', '11.103', '9.577', '5.232', '5.191', '7.015', '11.227', '4.42', '5.345', '9.714', '8.906', '6.688', '4.368', '5.235', '10.3', '7.232', '11.117', '8.562', '8.968', '8.101', '6.178', '5.104', '4.877', '4.536', '10.268', '10.725', '7.637', '8.777', '8.995', '7.352', '10.65', '9.217', '7.121', '7.924', '5.467', '7.274', '9.258', '6.933', '10.421', '10.937', '8.97', '7.712', '5.696', '5.692', '9.984', '6.61', '8.333', '7.19', '-0.865904928432', '7.04487593526e-18']
    exp = [137,136,135,124,123,121,133,120,131,130,84,83,140,143,144,147,125,134,122,112,132,94,106,93,129,90,89,87,138,95,114,103,86,141,102,146,99,97,104,110,139,101,108,100,98,96,92,91,116,126,115,119,118,117,128,127]
    meth = [5,7,9,10,14,8,11,13,16,17,47,49,44,48,50,59,19,12,6,29,15,31,35,37,18,38,39,41,40,74,28,36,43,46,53,57,67,64,32,45,42,55,61,58,73,66,30,34,25,26,27,23,24,20,21,22]
    x = []
    y = []
    for v in meth:
        x.append(float(test[v]))
    for v in exp:
        y.append(float(test[v]))
    print x
    print y
